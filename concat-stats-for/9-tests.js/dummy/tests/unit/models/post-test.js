define('dummy/tests/unit/models/post-test', ['ember-qunit', 'pretender'], function (_emberQunit, _pretender) {
  'use strict';
  ...
  (0, _emberQunit.test)('model action', function (assert) {
    assert.expect(3);
  ...
  (0, _emberQunit.test)('resource action', function (assert) {
    assert.expect(3);
  ...
  (0, _emberQunit.test)('resource action with params in GET', function (assert) {
    assert.expect(4);
  ...
  (0, _emberQunit.test)('resource action pushes to store', function (assert) {
    assert.expect(5);
  ...
  (0, _emberQunit.test)('responseTypes', async function (assert) {
    assert.expect(6);
    ...
    assert.equal(promiseArray.constructor.superclass, Ember.ArrayProxy);
    assert.equal(promiseObject.constructor.superclass, Ember.ObjectProxy);
  });
  ...
  (0, _emberQunit.test)('custom headers in non-customAction', function (assert) {
    assert.expect(2);
