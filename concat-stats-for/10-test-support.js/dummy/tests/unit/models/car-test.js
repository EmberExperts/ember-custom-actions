define('dummy/tests/unit/models/car-test', ['ember-qunit', 'pretender'], function (_emberQunit, _pretender) {
  'use strict';
  ...
  (0, _emberQunit.test)('creates default url for model action', function (assert) {
    assert.expect(3);
  ...
  (0, _emberQunit.test)('creates custom url with base url and custom request method for model action', function (assert) {
    assert.expect(2);
  ...
  (0, _emberQunit.test)('custom headers', function (assert) {
    assert.expect(2);
  ...
  (0, _emberQunit.test)('creates custom url for model action', function (assert) {
    assert.expect(2);
  ...
  (0, _emberQunit.test)('creates custom url for model action and passes adapterOptions', function (assert) {
    assert.expect(2);
  ...
  (0, _emberQunit.test)('creates default url for resource action', function (assert) {
    assert.expect(3);
  ...
  (0, _emberQunit.test)('creates custom url with base url for resource action', function (assert) {
    assert.expect(2);
  ...
  (0, _emberQunit.test)('creates custom url for resource action', function (assert) {
    assert.expect(2);
  ...
  (0, _emberQunit.test)('creates custom url for resource action and passes adapterOptions', function (assert) {
    assert.expect(2);
  ...
  (0, _emberQunit.test)('custom data from adapter', function (assert) {
    assert.expect(2);
