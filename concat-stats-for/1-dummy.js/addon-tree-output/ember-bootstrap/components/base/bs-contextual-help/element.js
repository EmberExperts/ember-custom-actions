define('ember-bootstrap/components/base/bs-contextual-help/element', ['exports', 'ember-bootstrap/templates/components/bs-tooltip/element'], function (exports, _element) {
  ...
  exports.default = Ember.Component.extend({
      ...
      return {
        ...
        offset: {
          fn: function fn(data) {
            ...
            (false && !(tip) && Ember.assert('Contextual help element needs existing popper element', tip));
    ...
    didReceiveAttrs: function didReceiveAttrs() {
      (false && !(this.get('id')) && Ember.assert('Contextual help element needs id for popper element', this.get('id')));
    },
